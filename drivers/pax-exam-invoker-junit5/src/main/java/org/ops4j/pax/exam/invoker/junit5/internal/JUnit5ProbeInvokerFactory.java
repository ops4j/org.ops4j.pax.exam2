...
/**
 * A {@link ProbeInvokerFactory} which creates {@link JUnit5ProbeInvoker}s.
 *
 * @author Harald Wellmann
 */
public class JUnit5ProbeInvokerFactory implements ProbeInvokerFactory {
    ...
    public ProbeInvoker createProbeInvoker(Object context, String expr) {
        ...
        return new JUnit5ProbeInvoker(ctx, injector);
    }
}
