 ...
 * 
 * This checks the current state of all bundles for a certain state range. The desiredMaxBundleState
 * argument may be ommited. In this case it will be set to desiredMinBundleState.
 */
