...
public class GlassFishLaunchTest
{
    ...
    {
        EmbeddedGlassFishTestContainer gftc = new EmbeddedGlassFishTestContainer( null, null );
    }
    ...
    public void launchGlassFish() throws Exception
    {
        ...
        glassFishHome = cm.getProperty( EmbeddedGlassFishTestContainer.GLASSFISH_HOME_KEY );
