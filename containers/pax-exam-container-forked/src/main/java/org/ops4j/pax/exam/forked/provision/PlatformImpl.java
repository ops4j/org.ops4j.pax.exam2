...
public class PlatformImpl
{
     ...
     *
     * @throws TestContainerException if the url could not be downloaded
     */
    public File download( final File workDir,
                           final URL url,
     ...
     *
     * @throws TestContainerException if the jar is not a valid bundle
     */
